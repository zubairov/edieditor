 ...
 */
package org.smooks.edi.editor.mappings;
...
/**
 * An implementation of {@link MappingsRegistry} specific to Eclipse resource
...
//		String targetURI = ("urn:org.milyn.edi.unedifact:" + nameComponents[3] + ":" + nameComponents[1] + nameComponents[2] + ":" + nameComponents[0]).toLowerCase();
//		IExtensionRegistry registry = Platform.getExtensionRegistry();
//		IExtensionPoint ep = registry.getExtensionPoint(XML_CATALOG_CONTRIBUTIONS_EXTENSION_POINT);
//		Map<String, EdifactModel> result = new LinkedHashMap<String, EdifactModel>();
//		if (ep != null) {
//			IExtension[] extensions = ep.getExtensions();
//			for (IExtension extension : extensions) {
//				try {
//					IConfigurationElement confEl = extension.getConfigurationElements()[0];
...
//								loadModel(result, uri, extension.getContributor());
//								break;
//							}
//						}
//					}
//				} catch (Exception e) {
//					System.err.println("Failed to process extension contribution from " + extension.getContributor().getName());
//					e.printStackTrace();
//				}
//			}
//		}
//		return result;
	...
	private void loadModel(Map<String, EdifactModel> result, String uri,
