 ...
 * <ul>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.SubsetImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.SubsetImpl#getVersionNum <em>Version Num</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.SubsetImpl#getReleaseNum <em>Release Num</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.SubsetImpl#getControllingAgencyCode <em>Controlling Agency Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubsetImpl extends EObjectImpl implements Subset {
	/**
	...
	protected EClass eStaticClass() {
		return V41Package.Literals.SUBSET;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SUBSET__ID, oldId, id));
	}
	...
	public void setVersionNum(String newVersionNum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SUBSET__VERSION_NUM, oldVersionNum, versionNum));
	}
	...
	public void setReleaseNum(String newReleaseNum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SUBSET__RELEASE_NUM, oldReleaseNum, releaseNum));
	}
	...
	public void setControllingAgencyCode(String newControllingAgencyCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SUBSET__CONTROLLING_AGENCY_CODE, oldControllingAgencyCode, controllingAgencyCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case V41Package.SUBSET__ID:
				return getId();
			case V41Package.SUBSET__VERSION_NUM:
				return getVersionNum();
			case V41Package.SUBSET__RELEASE_NUM:
				return getReleaseNum();
			case V41Package.SUBSET__CONTROLLING_AGENCY_CODE:
