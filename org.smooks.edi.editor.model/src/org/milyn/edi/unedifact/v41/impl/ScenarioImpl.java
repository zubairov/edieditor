 ...
 * <ul>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.ScenarioImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.ScenarioImpl#getVersionNum <em>Version Num</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.ScenarioImpl#getReleaseNum <em>Release Num</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.ScenarioImpl#getControllingAgencyCode <em>Controlling Agency Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScenarioImpl extends EObjectImpl implements Scenario {
	...
	protected EClass eStaticClass() {
		return V41Package.Literals.SCENARIO;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SCENARIO__ID, oldId, id));
	}
	...
	public void setVersionNum(String newVersionNum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SCENARIO__VERSION_NUM, oldVersionNum, versionNum));
	}
	...
	public void setReleaseNum(String newReleaseNum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SCENARIO__RELEASE_NUM, oldReleaseNum, releaseNum));
	}
	...
	public void setControllingAgencyCode(String newControllingAgencyCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SCENARIO__CONTROLLING_AGENCY_CODE, oldControllingAgencyCode, controllingAgencyCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case V41Package.SCENARIO__ID:
				return getId();
			case V41Package.SCENARIO__VERSION_NUM:
				return getVersionNum();
			case V41Package.SCENARIO__RELEASE_NUM:
				return getReleaseNum();
			case V41Package.SCENARIO__CONTROLLING_AGENCY_CODE:
