...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Recipientapp</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.RecipientappImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.RecipientappImpl#getCodeQualifier <em>Code Qualifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RecipientappImpl extends EObjectImpl implements Recipientapp {
	/**
	...
	protected EClass eStaticClass() {
		return V41Package.Literals.RECIPIENTAPP;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.RECIPIENTAPP__ID, oldId, id));
	}
	...
	public void setCodeQualifier(String newCodeQualifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.RECIPIENTAPP__CODE_QUALIFIER, oldCodeQualifier, codeQualifier));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case V41Package.RECIPIENTAPP__ID:
				return getId();
			case V41Package.RECIPIENTAPP__CODE_QUALIFIER:
