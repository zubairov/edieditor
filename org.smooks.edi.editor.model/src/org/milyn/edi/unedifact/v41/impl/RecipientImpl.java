 ...
 * <ul>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.RecipientImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.RecipientImpl#getCodeQualifier <em>Code Qualifier</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.RecipientImpl#getInternalId <em>Internal Id</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.RecipientImpl#getInternalSubId <em>Internal Sub Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RecipientImpl extends EObjectImpl implements Recipient {
	...
	protected EClass eStaticClass() {
		return V41Package.Literals.RECIPIENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.RECIPIENT__ID, oldId, id));
	}
	...
	public void setCodeQualifier(String newCodeQualifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.RECIPIENT__CODE_QUALIFIER, oldCodeQualifier, codeQualifier));
	}
	...
	public void setInternalId(String newInternalId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.RECIPIENT__INTERNAL_ID, oldInternalId, internalId));
	}
	...
	public void setInternalSubId(String newInternalSubId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.RECIPIENT__INTERNAL_SUB_ID, oldInternalSubId, internalSubId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case V41Package.RECIPIENT__ID:
				return getId();
			case V41Package.RECIPIENT__CODE_QUALIFIER:
				return getCodeQualifier();
			case V41Package.RECIPIENT__INTERNAL_ID:
				return getInternalId();
			case V41Package.RECIPIENT__INTERNAL_SUB_ID:
