 ...
 * <ul>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.SenderImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.SenderImpl#getCodeQualifier <em>Code Qualifier</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.SenderImpl#getInternalId <em>Internal Id</em>}</li>
 *   <li>{@link org.milyn.edi.unedifact.v41.impl.SenderImpl#getInternalSubId <em>Internal Sub Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SenderImpl extends EObjectImpl implements Sender {
	...
	protected EClass eStaticClass() {
		return V41Package.Literals.SENDER;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SENDER__ID, oldId, id));
	}
	...
	public void setCodeQualifier(String newCodeQualifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SENDER__CODE_QUALIFIER, oldCodeQualifier, codeQualifier));
	}
	...
	public void setInternalId(String newInternalId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SENDER__INTERNAL_ID, oldInternalId, internalId));
	}
	...
	public void setInternalSubId(String newInternalSubId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, V41Package.SENDER__INTERNAL_SUB_ID, oldInternalSubId, internalSubId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case V41Package.SENDER__ID:
				return getId();
			case V41Package.SENDER__CODE_QUALIFIER:
				return getCodeQualifier();
			case V41Package.SENDER__INTERNAL_ID:
				return getInternalId();
			case V41Package.SENDER__INTERNAL_SUB_ID:
